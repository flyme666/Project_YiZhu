...
public class ChooseFunctionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!libraryExists) {
            ...
            //initView();
            //ConfigUtil.setFtOrient(ChooseFunctionActivity.this, ASF_OP_ALL_OUT); // 直接选择360角度
        }
    }
...
//                        ConfigUtil.setFtOrient(ChooseFunctionActivity.this, ASF_OP_ALL_OUT); // 选择全面角度
//                        break;
